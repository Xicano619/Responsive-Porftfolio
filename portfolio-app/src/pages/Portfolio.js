        ...
        return (
            <Container>
                ...
                <main class="container">
                    ...
                    <div class="row">
                    <div class="col-sm-4">
                    <!-- Insert card class to portray previous projects -->
                    
                    <div class="col-sm-4">
                    <div class="card">
                        <img 
                        
                        src="./assets/images/HoriseonIMG.PNG"
                        class="img img-thumbnail card-img-top img-size"
                        alt="Image of marketing site, people working together at the office."
                        />
                        <div class="card">
                        <h5 class="card-title" ><a href="https://github.com/Xicano619/Marketing-Agency">Horiseon Marketing Agency</a></h5>
                        <p class="card-text">
                    ...
                    <div class="card">
                        ...
                        src="./assets/images/PasswordGenFinal.png"
                        class="img img-thumbnail card-img-top img-size"
                    ...
                    <div class="card">
                        ...
                        />
                        <div class="card-body">
                        <h5 class="card-title"><a href="https://github.com/Xicano619/Work-Day-Scheduler">Work-Day Schedular</a></h5>
                        <p class="card-text">
                    ...
                    <div class="card">
                        <img
                        src="./assets/images/weather-db.png"
                        class="img img-thumbnail card-img-top img-size"
                        alt="Application with city search input San Diego weather."
                        />
                        <div class="card-body">
                        <h5 class="card-title"><a href="https://github.com/Xicano619/Weather-Dashboard-">Weather Dashboard</a></h5>
                        <p class="card-text">
                    ...
                    <div class="card">
                        <img
                        src="./assets/images/Employee-tracker.jpg"
                        class="img img-thumbnail card-img-top img-size"
                        alt="..."
                        /> 
                        <div class="card-body">
                        <h5 class="card-title"><a href="https://github.com/Xicano619/Employee-Tracker">Employee-Tracker</a></h5>
                        <p class="card-text">
                    ...
                    <div class="card">
                        <img
                        src="./assets/images/SDC-Beer.png"
                        class="img img-thumbnail card-img-top img-size"
